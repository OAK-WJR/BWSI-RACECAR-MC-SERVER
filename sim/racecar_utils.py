...
try:
    ...
    # nptyping is only used for annotations like NDArray[(480, 640), np.uint8],
    # which Python evaluates at import time. A subscriptable stand-in keeps this
    # file byte-for-byte the official one everywhere else.
    class _NDArrayAnnotation:
        def __getitem__(self, item):
            return object

    NDArray = _NDArrayAnnotation()
